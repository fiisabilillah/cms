...
<a href="<?= base_url('foto/all/') ?>" class="btn btn-warning btn-sm kem1" id="kem1"><i class="far fa-arrow-alt-circle-left font-14"></i> Kembali Ke Album</a>
<?php if ($tambah == 1) { ?>
            ...
            <tbody>
                ...
                foreach ($list as $value) :
                    ...
                    <tr>
                        ...
                        <td class="p-1"><img class="img-circle elevation-2" src="<?= base_url('/public/img/galeri/foto/' . $value['gambar']) ?>" width="100px" height="50px"></td>
                        <td><?= $value['judul'] ?></td>
                        <td><?= $value['fullname'] ?></td>
                        <td class="text-center ">

                            <?php if ($ubah == 1) { ?>
                                <button type="button" title="Edit Data" class="btn btn-light btn-sm p-1" onclick="edit('<?= $value['foto_id'] ?>')">
                            ...
                            <?php if ($hapus == 1) { ?>
                                <button type="button" title="Hapus Data" class="btn btn-light btn-sm p-1" onclick="hapus('<?= $value['foto_id'] ?>','<?= $value['judul'] ?>')">
