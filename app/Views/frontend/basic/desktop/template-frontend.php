 ...
 ======================================================== -->
  ...
  <head>
      ...
      <script src="<?= base_url('/public/template/frontend/' . $folder . '/desktop/assets/js/sweetalert2.js') ?>"></script>

      <script src="<?= base_url('/public/template/frontend/' . $folder . '/desktop/assets/libs/jquery/jquery-3.7.1.min.js') ?>"></script>
      <script src='https://www.google.com/recaptcha/api.js'></script>
      <!-- widget -->
      <link href="<?= base_url('/public/template/frontend/' . $folder . '/desktop/assets/css/dataTables.bootstrap4.min.css') ?>" rel="stylesheet" type="text/css" />
      ...
      <link href="<?= base_url('/public/template/frontend/' . $folder . '/desktop/assets/css/owl.carousel.css') ?>" rel="stylesheet" type="text/css" />
      <link href="<?= base_url('/public/template/frontend/' . $folder . '/desktop/assets/css/wajib.css') ?>" rel="stylesheet" type="text/css" />
  ...
  <script src="<?= base_url('/public/template/frontend/' . $folder . '/desktop/assets/js/datagoe/jquery.waypoints.min.js') ?>"></script>
  <script src="<?= base_url('/public/template/frontend/' . $folder . '/desktop/assets/js/datagoe/owl.carousel.min.js') ?>"></script>
  <script src="<?= base_url('/public/template/frontend/' . $folder . '/desktop/assets/js/datagoe/moddatagoe.js') ?>"></script>

  <script src="<?= base_url('/public/template/frontend/' . $folder . '/desktop/assets/js/purecounter.js') ?>"></script>

  </html>

  <?= $this->include('/backend/' . $tadmin['folder'] . '/modal/getjs'); ?>
