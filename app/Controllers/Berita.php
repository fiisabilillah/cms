    ...
    public function listdata2()
    {
        ...
        foreach ($lists as $list) {
            ...
            if ($list->status == '1') {
                ...
                <span class="text-danger" title="Telah dilihat" style="font-size:13px"> (' . $list->hits . ') </span>';
            } else {
                if ($akses == '1') {
                ...
                <span class="text-danger" title="Dilihat" style="font-size:13px"> (' . $list->hits . ') </span>';
            }
