    ...
    <table id="listkategorifoto" class="table table-hover table-striped table-bordered">
        ...
        <tbody>
            ...
            foreach ($list as $data) :
                ...
                $jfoto = $this->foto->where('kategorifoto_id', $data['kategorifoto_id'])->get()->getNumRows();
            ...
            ?>
                <tr>
                    ...
                    <td class="text-center">
                        <?php if ($ubah == 1) { ?>
                            <img class="img-circle elevation-2 pointer p-0" onclick="gantifoto('<?= $data['kategorifoto_id'] ?>')" src="<?= base_url('public/img/galeri/katfoto/' . $data['cover_foto']) ?>" title="Ganti Cover" width="60px">
                        <?php } else { ?>
                            <img class="img-circle elevation-2 p-0" src="<?= base_url('public/img/galeri/katfoto/' . $data['cover_foto']) ?>" width="60px">
