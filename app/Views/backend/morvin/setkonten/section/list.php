...
<?php } ?>
<small class="text-secondary"> Ukuran gambar section akan di crop ukuran <strong class="text-danger">300x300 px</strong>. </small>
<hr>
        ...
        <tbody>
            ...
            foreach ($list as $value) :
                ...
                <tr>
                    ...
                    <td class="p-1 text-center"><img class="img-circle elevation-2" src="<?= base_url('/public/img/section/' . $value['gambar']) ?>" width="50"></td>
