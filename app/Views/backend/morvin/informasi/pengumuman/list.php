                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <?php if ($data['gambar'] == 'default.png') { ?>
                            <span class="badge badge-warning pointer" style="font-size:12px" <?= $eksekusi ?> title="Tambahkan Cover">No Cover </span>
                        <?php } else { ?>
                            <img class="img-circle elevation-2 pointer" title="Ganti Gambar" <?= $eksekusi ?> src="<?= base_url('public/img/informasi/pengumuman/' . $data['gambar']) ?>" height="100%" width="45px">
                        <?php } ?>
                    </td>
                    <td class="text-center ">
                        <?php if ($ubah == 1) { ?>
