            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="nama_subsubmenu" name="nama_subsubmenu" value="<?= $nama_subsubmenu ?>" class="form-control">
                ...
                <div>
                    ...
                    <div class="form-group mb-2" id="eksternal">
                        ...
                        <input type="text" id="link_subsubmenu" name="link_subsubmenu" value="<?= $link_subsubmenu ?>" class="form-control">
                        <div class="invalid-feedback errorlink_subsubmenu"></div>
                    </div>
                    <input type="hidden" id="linkexternalssm" name="linkexternalssm" value="<?= $linkexternalssm ?>" class="form-control">
                </div>
                <div class="form-group mb-2">
                    <label>Link Sebelumnya</label>
                    <input type="text" id="link_subsubmenuold" name="link_subsubmenuold" readonly value="<?= $link_subsubmenu ?>" class="form-control">

                </div>
                <div class="row">
                    <div class="form-group col-md-6 col-12 mb-2">
                        <label>Urutan Sub Menu</label>
                        <input type="number" class="form-control" id="urutanssm" name="urutanssm" value="<?= $urutanssm ?>">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <div class="form-control p-0">
                            &nbsp; <input type="radio" name="targetssm" id="targetssm1" value="_parent" <?= $targetssm == '_parent' ? 'checked' : '' ?>> <label for="targetssm1" class="pointer pt-2"> _parent &nbsp</label>
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" class="form-control" id="iconssm" name="iconssm" value="<?= $iconssm ?>">
                    </div>
