                                    ...
                                    <?php if ($berita->sts_komen != '0') { ?>
                                        ...
                                        <div class="blog-comments">
                                                    ...
                                                    <div class="item">
                                                        <?php foreach ($komen as $data) { ?>
                                                            <div class="comment-img">
                                                                <img class="img-circle comment-img float-left" src="<?= base_url('public/template/backend/img/usr2.png') ?>" alt="img">
                                                            </div>
                                                            <div>
                                            ...
                                            <div class="reply-form">
                                                ...
                                                <p>
                                                <div class="alert alert-info" style='background-color:#f4f4f4; border-color:#e3e3e3;'>
                                                    <img style='float:left; padding: 7px; margin-top:-8px; margin-right:3px;' width="65" class="pull-left" src="<?= base_url('public/template/backend/img/icon_rules.png') ?>">
