                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="blog-comments mt-1">
                                                    ...
                                                    ?>
                                                        <div class="alert alert-info" style='background-color:#f8f9f4; border-color:#e3e3e3;'>
                                                            <div class="comment-img">
                                                                <img class="img-circle comment-img float-left" src="<?= base_url('public/template/backend/img/usr2.png') ?>" width="50" alt="Nama">
                                                            </div>
                                                            <div>
                                                            ...
                                                            <div class="comment-img">
                                                                <img class="comment-img float-left" src="<?= base_url('public/template/backend/img/adm.png') ?>" width="100" alt="Admin">
                                                            </div>
                                                            <!-- <div> -->
                                        ...
                                        <div class="alert alert-info" style='background-color:#f4f4f4; border-color:#e3e3e3;'>
                                            <img style='float:left; padding: 8px; margin-top:-13px; margin-right:5px;' width="95" class="pull-left" src="<?= base_url('public/template/backend/img/icon_rules.png') ?>">
