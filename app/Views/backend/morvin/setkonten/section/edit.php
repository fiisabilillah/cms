            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="nama_section" name="nama_section" value="<?= $nama_section ?>" class="form-control ">
                        <div class="invalid-feedback errornama_section"></div>
                    </div>

                    <div class="form-group col-md-6 col-12 mb-2">
                        <label><i class="mdi mdi-link-variant"></i> Link saat ini</label>
                        <input type="text" id="linkold" name="linkold" title="<?= $link ?>" readonly value="<?= $link ?>" class="form-control ">
                ...
                <!-- Single menu start -->
                <input type="hidden" id="linksumber" name="linksumber" value="<?= $linksumber ?>" class="form-control ">
                <div id="single">
