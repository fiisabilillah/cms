        ...
        <table id="listvideo" class="table table-hover table-striped table-bordered">
            ...
            <thead>
                <tr>
                    ...
                    <th width="75" class="text-center"><b>AKSI</b> </th>
                ...
                foreach ($list as $value) :
                    ...
                    <tr>
                        ...
                        <td class="text-center ">
                            <img class="img-circle elevation-2 pointer" title="<?= $value['ket_video'] ?>" src="https://img.youtube.com/vi/<?php echo $value['video_link'] ?>/mqdefault.jpg" width="100" alt="<?= $value['video_id'] ?>">
                        </td>
                        ...
                        <td class="text-center ">
                            ...
                            <?php if ($hapus == 1) { ?>
                                <button type="button" title="Hapus Data" class="btn btn-light btn-sm p-1" onclick="hapus('<?= $value['video_id'] ?>','<?= $value['judul'] ?>')">
