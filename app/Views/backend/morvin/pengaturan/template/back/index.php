        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="page-title">
                    <h4 class="text-light"><i class="mdi mdi-palette"></i> <?= $title ?></h4>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="float-end d-none d-sm-block">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('template/') ?>">Template</a></li>
            ...
            <div class="card m-b-20">
                ...
                <!-- <div class="card-header font-18 bg-light">
                    <h6 class="modal-title mt-0">
                        <i class="mdi mdi-palette"></i> Template Dashboard
                    </h6>
                </div> -->
...
<script>
    function listtemplateback() {
        $.ajax({
            url: "<?= site_url('template/getdataback') ?>",
            dataType: "json",
