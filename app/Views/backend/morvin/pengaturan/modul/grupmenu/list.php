...
<small class="text-secondary">Modul ini untuk Membuat Menu Utama pada Backend CMS dan <strong class="text-danger"> pembuatan Grup baru, </strong> (jika ada modul baru dgn pengelompokan baru). </small>
<hr>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="p-1">&nbsp;<i class="<?= $data['ikonmn'] ?>"></i> <a class="text-primary" href="<?= base_url('submodul/' . $data['gm']) ?>"><?= esc($data['modul']) ?><a class="text-danger" title="Jumlah Submenu"> (<?= esc($jumgm['gm']) ?>)</a></a></td>
                    ...
                    <td class="text-center p-1">
                        <?php if ($akses == 1) { ?>
                            ...
                            <button type="button" class="btn btn-light btn-sm p-1" title="Ganti Nama Menu" onclick="edit('<?= $data['id_modul'] ?>')">
                                <i class="icon fas fa-edit text-warning"></i>
                            </button>
                            <?php if ($jumgm['gm'] == 0) { ?>
                                <button type="button" class="btn btn-light btn-sm p-1" title="Hapus Data Grup" onclick="hapus('<?= $data['id_modul'] ?>')">
                            ...
                            <button type="button" class="btn btn-social btn-flat btn-light btn-sm p-1" title="Kelola Akses Menu" onclick="setakses('<?= $data['id_modul'] ?>')">
