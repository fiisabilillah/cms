        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group  mb-2">
                    ...
                    <input type="text" class="form-control" id="menu_linkold" name="menu_linkold" readonly value="<?= $menu_link ?>">
                </div>
                ...
                <div id="single">
                    ...
                    <div class="form-group mb-2" id="eksternal">
                        ...
                        <input type="text" id="menu_link" name="menu_link" value="<?= $menu_link ?>" class="form-control">
                        <div class="invalid-feedback errorgm"></div>
                    </div>

                    <input type="hidden" id="linkexternal" name="linkexternal" value="<?= $linkexternal ?>" class="form-control">
                </div>
                <!-- end single -->
