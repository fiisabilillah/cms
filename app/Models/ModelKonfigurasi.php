...
class ModelKonfigurasi extends Model
{
    ...
    protected $allowedFields = [
        ...
        'sts_section', 'nama_pimpinan', 'jabatan_pimpinan', 'sts_sambutan', 'sts_modal', 'sts_count', 'sts_rt', 'sts_regis', 'sts_web', 'sts_posting',
        'smtp_host', 'smtp_username', 'smtp_password', 'smtp_port', 'smtp_pengirim', 'ukuran_upload', 'smtp_pesanbalas', 'g_sitekey', 'g_secretkey', 'vercms', 'konek_opd', 'id_grup', 'footer_cms', 'katamutiara', 'tokenwa', 'no_waysender', 'wa_penerima', 'namasingkat', 'urlserver', 'is_maintenance'
    ];
