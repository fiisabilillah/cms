...
<?php } ?>
<small class="text-secondary"> Pastikan script class CSS yang ditambah / dimodifikasi tersedia pada <strong class="text-danger">Template</strong> yang diterapkan.</small>
<hr>
        ...
        <tbody>
            ...
            foreach ($list as $value) :
                ...
                <tr>
                    ...
                    <td class=" text-center">
                        <?php if ($value['gambar'] == '') { ?>
                            <span class="badge badge-soft-danger pointer" style="font-size:12px" onclick="gantifoto(' <?= $value['section_id'] ?> ')" title="Tambahkan Gambar">No Image </span>
                        <?php } else { ?>
                            <img class="img-circle elevation-2 pointer" title="Ganti Gambar" onclick="gantifoto('<?= $value['section_id'] ?>')" src="<?= base_url('/public/img/section/' . $value['gambar']) ?>" width="80" height="50">
                        <?php } ?>

                    </td>
                    <td class=""><?= $value['nama_section'] ?></td>
                    <td class=""><?= $value['nama'] ?></td>
                    <td class=" text-center"><?= $value['urutan'] ?></td>

                    <td class="text-center ">
                        <?php if ($ubah == 1) { ?>
                            <button type="button" class="btn btn-light btn-sm p-1" onclick="edit('<?= $value['section_id'] ?>')">
                        ...
                        <?php } ?>
                        <?php if ($hapus == 1) { ?>
                            <button type="button" class="btn btn-light btn-sm p-1" onclick="hapus('<?= $value['section_id'] ?>','<?= $value['nama_section'] ?>')">
