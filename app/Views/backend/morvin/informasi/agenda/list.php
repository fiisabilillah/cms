                ...
                <tr>
                    ...
                    <td class="text-center">
                        <?php if ($data['gambar'] == 'default.png') { ?>
                            <span class="badge badge-soft-warning font-size-12 pointer" style="font-size:12px" onclick="gantifoto(' <?= $data['agenda_id'] ?> ')" title="Tambahkan Cover">No Cover </span>
                        <?php } else { ?>
                    ...
                    <td class="text-center">
                        ...
                        <?php } ?>
                        <?php if ($hapus == 1) { ?>
                            <button type="button" class="btn btn-light btn-sm p-1" onclick="hapus('<?= $data['agenda_id'] ?>','<?= $data['tema'] ?>')">
