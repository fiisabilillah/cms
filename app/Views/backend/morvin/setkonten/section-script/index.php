        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="page-title">
                    <h4 class="text-light"><i class="mdi mdi-console"></i> Data <?= $subtitle ?> Script</h4>
            ...
            <div class="col-sm-6">
                <div class="float-end d-none d-sm-block">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"> <?= $subtitle ?> Script</li>
                    </ol>
...
<div class="page-content-wrapper">
    ...
    <script>
        function listsection() {
            $.ajax({
                url: "<?= site_url('section-script/getdata') ?>",
                dataType: "json",
