            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-7 col-12 mb-2">
                        ...
                        <input type="text" class="form-control" value="<?= $nama_section ?>" id="nama_section" name="nama_section">
                    ...
                    <div class="form-group col-md-3 col-12 mb-2">
                        ...
                        <select name="template_id" id="template_id" class="form-select pointer">
                            ...
                            <?php foreach ($template as $key => $data) { ?>
                                ...
                                <option value="<?= $data['template_id'] ?>" <?= $template_id ==  $data['template_id'] ? 'selected' : '' ?>><?= $data['nama'] ?></option>
                            <?php } ?>
                        </select>
