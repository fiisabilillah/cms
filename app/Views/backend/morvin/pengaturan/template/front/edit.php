        ...
        <div class="modal-content">
            ...
            <div class='card-body pt-1'>
                ...
                <ul class="nav nav-tabs nav-tabs-custom" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#gambarkover" role="tab">Gambar Cover</a>
                    </li>
                </ul>
                    ...
                    <div class="tab-pane active " id="home1" role="tabpanel">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 col-12 mb-2">
                                ...
                                <!-- <input type="text" class="form-control" id="folder" name="folder" value="<?= $folder ?>" title="Pastikan nama folder di public dan views sama..!" placeholder="Folder sama di Public & Views"> -->
