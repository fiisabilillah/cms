    ...
    <table id="listuser" class="table table-hover table-striped table-bordered">
        ...
        <thead class="badge-soft-secondary">
            <tr>
                ...
                <th width="110" class="text-center"><b>Aksi</b> </th>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="">
                        <?php if ($ubah == 1) { ?>
                            <img class="img-circle elevation-2 rounded pointer" onclick="gantifoto('<?= $value['id'] ?>')" src="<?= base_url('public/img/user/' . $profil) ?>" width="40px" title="Klik disini untuk Ganti Foto">
                        <?php } else { ?>
                            <img class="img-circle elevation-2 rounded " src="<?= base_url('public/img/user/' . $profil) ?>" width="40px">
                        <?php } ?>
                    </td>
