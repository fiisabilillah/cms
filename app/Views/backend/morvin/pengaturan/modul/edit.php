            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="modul" name="modul" value="<?= $modul ?>" class="form-control">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        ?>
                        <input type="text" id="urlmenu" name="urlmenu" value="<?= $urlmenu ?>" placeholder="Link Controler utk Akses Modul" class="form-control" <?= $ron ?>>
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="ikonmn" name="ikonmn" value="<?= $ikonmn ?>" placeholder="Jika tdk dijadikan menu abaikan." class="form-control">
                    </div>
