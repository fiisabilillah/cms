        ...
        foreach ($lists as $list) {
            ...
            if ($ubah == '1') {
                ...
                if ($list->gambar == 'default.png') {
                    $gambar = '<span class="text-warning pointer" style="font-size:12px" onclick="gantifoto(' . $list->berita_id . ')" title="Tambahkan Cover" >No Cover </span>';
                } else {
                ...
                if ($list->gambar == 'default.png') {
                    $gambar = '<span class="text-warning pointer" style="font-size:12px" >No Cover </span>';
                } else {
