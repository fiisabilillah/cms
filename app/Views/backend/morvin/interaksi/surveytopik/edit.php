        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" class="form-control form-control-sm" id="nama_survey" value="<?= $nama_survey ?>" name="nama_survey">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="ket_stb" name="ket_stb" value="<?= $ket_stb ?>" class="form-control form-control-sm" placeholder="Sangat tidak baik">
                    ...
                    <div class="form-group col-md-3 col-12 mb-2">
                        ...
                        <input type="number" id="r1_stb" name="r1_stb" value="<?= $r1_stb ?>" class="form-control form-control-sm" readonly>
                    ...
                    <div class="form-group col-md-3 col-12 mb-2">
                        ...
                        <input type="number" id="r2_stb" name="r2_stb" value="<?= $r2_stb ?>" class=" form-control form-control-sm" readonly>
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="ket_kb" name="ket_kb" value="<?= $ket_kb ?>" class=" form-control form-control-sm" placeholder="Kurang Baik">
                    ...
                    <div class="form-group col-md-3 col-12 mb-2">
                        ...
                        <input type="number" id="r1_kb" name="r1_kb" value="<?= $r1_kb ?>" class="form-control form-control-sm" readonly>
                    ...
                    <div class="form-group col-md-3 col-12 mb-2">
                        ...
                        <input type="number" id="r2_kb" name="r2_kb" value="<?= $r2_kb ?>" class=" form-control form-control-sm" readonly>
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="ket_b" name="ket_b" value="<?= $ket_b ?>" class=" form-control form-control-sm" placeholder="Baik">
                    ...
                    <div class="form-group col-md-3 col-12 mb-2">
                        ...
                        <input type="number" id="r1_b" name="r1_b" value="<?= $r1_b ?>" class="form-control form-control-sm" readonly>
                    ...
                    <div class="form-group col-md-3 col-12">
                        ...
                        <input type="number" id="r2_b" name="r2_b" value="<?= $r2_b ?>" class=" form-control form-control-sm" readonly>
                    ...
                    <div class="form-group col-md-6 col-12">
                        ...
                        <input type="text" id="ket_sb" name="ket_sb" value="<?= $ket_sb ?>" class=" form-control form-control-sm" placeholder="Sangat Baik">
                    ...
                    <div class="form-group col-md-6 col-12">
                        ...
                        <input type="number" id="r1_sb" name="r1_sb" value="<?= $r1_sb ?>" class="form-control form-control-sm" readonly>
