        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="page-title">
                    <h4 class="text-light"><i class="mdi mdi-scale-balance"></i> <?= $data['nama_kathukum'] ?></h4>
            ...
            <div class="col-sm-6">
                <div class="float-end d-none d-sm-block">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('produkhukum/subproduk/' . $data['produk_id']) ?>"><?= $data['nama_produk'] ?></a></li>
                        <li class="breadcrumb-item active"><?= $data['nama_kathukum'] ?></li>
                    </ol>
