                ...
                <tr>
                    ...
                    <td class="text-center p-1">
                        <?php if ($ubah == 1) { ?>
                            ...
                            <?php } else { ?>
                                <img class="img-circle elevation-2 pointer" title="Ganti Gambar" onclick="ganticover('<?= $value['ebook_id'] ?>')" src="<?= base_url('public/img/ebook/' . $value['gambar']) ?>" width="40px">
                            <?php } ?>
                        <?php } else { ?>
                            <?php if ($value['gambar'] == 'default.png') { ?>
                                <span class="badge badge-warning " style="font-size:12px">No Cover </span>
                            <?php } else { ?>
                                <img class="img-circle elevation-2 " src="<?= base_url('public/img/ebook/' . $value['gambar']) ?>" width="50px">
                            <?php } ?>
                        <?php } ?>
                    </td>
                    <td class="p-1">
                    ...
                    <td class="text-center p-1">
                        <?php if ($ubah == 1) { ?>
                            ...
                            <?php if ($value['status'] == '1') { ?>
                                <button type="button" class="btn btn-circle btn-sm p-1 <?= $value['status'] ? 'btn-light' : 'btn-success' ?>" title="<?= $value['status'] ? 'Aktif' : 'Tidak Aktif' ?>"><i class="fas fa-check-circle text-success"></i>
                                </button>
                            <?php } else { ?>
                                <button type="button" class="btn btn-circle btn-sm p-1 <?= $value['status'] ? 'btn-info' : 'btn-light' ?>" title="<?= $value['status'] ? 'Tidak Aktif' : 'Tidak Aktif' ?>"><i class="nav-icon far fa-eye text-danger"></i>
                                </button>
                        <?php }
                        }
                        ?>
                        ...
                        <?php if ($hapus == 1) { ?>
                            <button type="button" class="btn btn-light btn-sm p-1" onclick="hapus('<?= $value['ebook_id'] ?>','<?= $value['judul'] ?>')">
