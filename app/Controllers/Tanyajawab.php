...
class Tanyajawab extends BaseController
{
    public function index()
    {
        ...
        $data = [
            'title'         => 'Tanya Jawab | ' . $konfigurasi->nama,
            ...
            'kategori'      => $kategori,
            'kategorifaq'   => $this->masterdata->list1(),
        ...
        if ($template['duatema'] == 1) {
            ...
            if ($agent->isMobile()) {
                return view('frontend/' . $template['folder'] . '/mobile/' . 'content/tanyajawab', $data);
            } else {
                return view('frontend/' . $template['folder'] . '/desktop/' . 'content/tanyajawab', $data);
            }
        } else {
            return view('frontend/' . $template['folder'] . '/desktop/' . 'content/tanyajawab', $data);
        }
    ...
    public function formtambah()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                ...
                'kategori'     => $this->masterdata->list1(),
            ];
            $msg = [
