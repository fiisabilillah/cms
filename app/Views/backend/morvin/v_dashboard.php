            ...
            <div class="card shadow-lg">
                <div class="card-body ">
                    <div class="media">
                        <div class="media-body overflow-hidden">
                            ...
                            <h3 class="font-22 fw-bold mb-0"><?= format_rupiah($beritaall) ?></h3>
                ...
                <div class="card-body border-top py-2">
                    <div class="text-truncate">
                        <span class="badge badge-soft-primary p-1 font-size-13"> <strong><?= $kategori ?></strong> </span>
                        <span class="text-muted ml-2"> Kategori</span>
                        &nbsp; <span class="dash-goal text-muted mr-8 font-size-13"> &nbsp; &nbsp;<span class="badge badge-soft-primary p-1 font-size-13"> <strong> <?= $tagar['tag_id'] ?></strong> </span> Tagar </span>
                    </div>
                ...
                <div class="card-body ">
                    <div class="media">
                        <div class="media-body overflow-hidden">
                            ...
                            <h3 class="font-22 fw-bold mb-0"><?= format_rupiah($totlayanan) ?></h3>
                ...
                <div class="card-body ">
                    <div class="media">
                        <div class="media-body overflow-hidden">
                            ...
                            <?php if ($bankdata) {
                                $bankdataall = $bankdata['bankdata_id'];
                            } else {
                                $bankdataall = 0;
                            } ?>
                            <h3 class="font-22 fw-bold mb-0"><?= format_rupiah($bankdataall) ?></h3>
                ...
                <div class="card-body ">
                    <div class="media">
                        <div class="media-body overflow-hidden">
                            ...
                            <h3 class="font-22 fw-bold mb-0"><?= format_rupiah($totpengumuman) ?></h3>
                                ...
                                foreach ($agenda5 as $data) : ?>
                                    <li class="activity-list activity-border">
                                        ...
                                        <div class="activity-icon avatar-sm">
                                            ...
                                            <?php } else { ?>
                                                <img src="<?= base_url('public/img/informasi/agenda/' . $data['gambar']) ?>" class="avatar-sm rounded-circle" alt="">
                                            <?php } ?>
                                        </div>
                                        <div>
                                            <div>
                                                <h5 class="font-size-13"><?= date_indo($data['tgl_mulai']) ?> <small class="text-muted"><?= $data['jam'] ?></small></h5>
                                            </div>

                                            <div>
                                                <p class="text-muted mb-0"><?= $data['tema'] ?></p>
                                            </div>
                                        </div>
                                    </li>
                                <?php endforeach;
                                ...
                                <tbody>
                                    <?php if ($beritapopuler) {
                                        ...
                                        foreach ($beritapopuler as $data) :  ?>
                                            <tr>
                                                <td class="text-center"> <a href="<?= base_url('detail/' . $data['slug_berita']) ?>" target="_blank"><img class="img-circle elevation-2" src="<?= base_url('/public/img/informasi/berita/' . $data['gambar']) ?>" width="50px"></td>

                                                <td>
                                                    <h8 class="mt-0"><a href="<?= base_url('detail/' . $data['slug_berita']) ?>" target="_blank"><?= $data['judul_berita'] ?> <span class="badge badge-pill badge-soft-danger font-size-12">(<?= $data['hits'] ?>)</span></h6>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php } ?>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="mt-0 mt-sm-0">
                                    ...
                                    <h5 class="font-size-18 mb-1"><?= format_rupiah($kritiknew) ?></h5>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 dash-goal">
                                ...
                                <div class="mt-0 mt-sm-0">
                                    ...
                                    <h5 class="font-size-18 mb-1"><?= format_rupiah($kritikpublish) ?></h5>
                                </div>
                            ...
                            <div class="col-md-3 dash-goal">
                                ...
                                <div class="mt-0 mt-sm-0">
                                    ...
                                    <h5 class="font-size-18  mb-1"><?= format_rupiah($kritikunpublish) ?></h5>
                                </div>
                            ...
                            <div class="col-md-3 dash-goal">
                                ...
                                <div class="mt-0 mt-sm-0">
                                    ...
                                    <h5 class="font-size-18 mb-1"><?= format_rupiah($kritikall) ?></h5>
                                </div>
